  ...
  return (
    <section id={id} className={`container mx-auto px-4 ${styles.technology}`}>
      <div className={styles.technology_content}>
        ...
        <div
          className={`grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ${styles.technology_list}`}
        >
          {Object.entries(technologyData).map(([group, techList], index) => (
            <div key={index} className={styles.technology_card}>
              <h3
                className={styles.technology_card_title}
              ...
              <div
                className={`${styles.technology_card_icons} ${
                  openCardIndex === index ? styles.open : styles.closed
                }`}
              >
